...
class Home extends Component {
  ...
  render() {
    return (
      <div className="Home">
          <TitleImage/>
          <Products id="product-01"callQuickPage={this.displayQuickViewPage} titleDisplay='block' title="Authentic World Cup Kits" home_products={this.props.home_products}/>
