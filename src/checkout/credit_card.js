...
class CreditCard extends Component {
    ...
    paymentDetailsUpdateAction = () => {
        const paymentDetails = {
            card_number: `${this.state.card_name_part1 + this.state.card_name_part2 + this.state.card_name_part3 + this.state.card_name_part4}`,
    ...
    onCardNameInputChange = (event) => {
        if (event.target.id === "first-part" && event.target.value.length <= 4) {
        ...
        if (event.target.id === "second-part" && event.target.value.length <= 4) {
        ...
        if (event.target.id === "third-part" && event.target.value.length <= 4) {
            this.setState({ card_name_part3: event.target.value })
        }
        if (event.target.id === "third-part" && event.target.value.length === 4) {
            this.cardname_ref4.current.focus();
        }
        if (event.target.id === "fourth-part" && event.target.value.length <= 4 ) {
