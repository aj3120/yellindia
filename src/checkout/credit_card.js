...
const mapDispatchToProps = (dispatch) => {
    return ({ action: bindActionCreators({  paymentDetailsAction }, dispatch) })
}
...
class CreditCard extends Component {
    ...
    paymentDetailsUpdateAction=()=>{
        const paymentDetails = { card_number: `${this.state.card_name_part1+this.state.card_name_part2+this.state.card_name_part3+this.state.card_name_part4}`, 
    ...
    onCardNamePart1InputChange = (event) => {
    ...
    onCardNamePart2InputChange = (event) => {
         if (event.target.id === "third-part") {
            if (event.target.value.length <= 4)
    ...
    onCardMonthInputChange = (event) => {   
        ...
        else if (event.target.id === "cvv" && event.target.value.length <= 3) {
            ...
            <div className="Payment-Mobile-Credit-Card">
                ...
                <div className="Payment-Mobile-Input">
                    <div className="Payment-Mobile-Card_number" style={this.props.credit_box_style}>
                        ...
                        <input id="first-part" placeholder="1234" onClick={(event)=>this.props.paymentMode(event)}type="number" onChange={this.onCardNamePart1InputChange} value={this.state.card_name_part1} style={{ display: this.state.card_name_show_upto_three }} />
                        <input id="second-part" placeholder="1234" onClick={(event)=>this.props.paymentMode(event)}  ref={this.cardname_ref2} type="number" onChange={this.onCardNamePart1InputChange} value={this.state.card_name_part2} style={{ display: this.state.card_name_show_upto_three }} />
                        <input id="third-part" placeholder="1234"   onClick={(event)=>this.props.paymentMode(event)} ref={this.cardname_ref3} type="number" onChange={this.onCardNamePart2InputChange} value={this.state.card_name_part3} style={{ display: this.state.card_name_show_upto_three }} />
                        <input id="fourth-part" placeholder="1234" onClick={this.showCardNumber} ref={this.cardname_ref4} type="number" onChange={this.onCardNamePart2InputChange} value={this.state.card_name_part4} style={{ display: this.state.card_name_show_part4 }} />
